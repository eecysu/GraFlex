...
void BuildDisCSR (void)
{
  ...
  uint tailIdx = (node_num/32+2) * 4; // 32 = 8*4
  for (k=0; k<NUM_PE; ++k)
  {
...
int main (int argc, char *argv[])
{
  ...
  */
  ...
  string krnl_name_full = "inst_bfs_8x1_v1:{inst_bfs_8x1_v1_1}";
  ...
  q.enqueueMigrateMemObjects({
    ...
    buffer_CSR_E[0], buffer_CSR_E[1], buffer_CSR_E[2], buffer_CSR_E[3], buffer_CSR_E[4],  buffer_CSR_E[5], buffer_CSR_E[6], buffer_CSR_E[7]}, 0);
  q.finish();
