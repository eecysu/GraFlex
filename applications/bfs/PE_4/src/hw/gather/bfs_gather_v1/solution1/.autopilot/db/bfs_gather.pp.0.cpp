# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.cpp" 2
# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.h" 1
...
# 5 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.h" 2
...
# 6 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.h" 2
...
# 7 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.h" 2
...
# 8 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.h" 2
...
# 10 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.h" 2
...
__attribute__((sdx_kernel("BFS_Gather", 0))) void BFS_Gather(const uint8_t peID, volatile uint32_t *sw_data,
                  volatile bool *exist, dpkt_t tmp_dist[4][4096]);
# 2 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.cpp" 2

__attribute__((sdx_kernel("BFS_Gather", 0))) void BFS_Gather(const uint8_t peID, volatile uint32_t *sw_data,
                  volatile bool *exist, dpkt_t tmp_dist[4][4096])
{_ssdm_SpecArrayDimSize(tmp_dist, 4);
#pragma HLS TOP name=BFS_Gather
# 5 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/gather/bfs_gather.cpp"
...
#pragma HLS pipeline II=2
 ...
 uint32_t rltDstIdx, rltBank, rltAddr;
  ...
  rltDstIdx= (dstVid-peID) / (4*8);
  rltBank = rltDstIdx % 4;
  rltAddr = rltDstIdx / (4*8);

  dstVal = tmp_dist[rltBank][rltAddr];

  switch (rltDstIdx/4 % 8)
  {
    case 0:
