set moduleName BFS_Ctrl_4X1_VER1
set isTopModule 1
...
set C_modelName {BFS_Ctrl_4X1_VER1}
...
set C_modelArgList {
	...
	{ cnt_gather_1 int 32 unused {pointer 0}  }
	{ cnt_gather_2 int 32 unused {pointer 0}  }
	{ cnt_gather_3 int 32 unused {pointer 0}  }
...
set portList { 
	...
	{ cnt_gather_0 sc_in sc_lv 32 signal 8 } 
	{ cnt_gather_1 sc_in sc_lv 32 signal 9 } 
	{ cnt_gather_2 sc_in sc_lv 32 signal 10 } 
	{ cnt_gather_3 sc_in sc_lv 32 signal 11 } 
	{ exist_0 sc_in sc_logic 1 signal 12 } 
	{ exist_1 sc_in sc_logic 1 signal 13 } 
	{ exist_2 sc_in sc_logic 1 signal 14 } 
	{ exist_3 sc_in sc_logic 1 signal 15 } 
}
set NewPortList {[ 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "dummyParam", "Type" : "None", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "grp_BFS_PE_fu_172", "Port" : "dummyParam"}]},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_BFS_PE_fu_172", "Parent" : "0",
		"CDFG" : "BFS_PE",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1", "real_start" : "0",
		"Pipeline" : "None", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
...
set ArgLastReadFirstWriteLatency {
	BFS_Ctrl_4X1_VER1 {
		...
		cnt_scatter_0 {Type I LastRead 7 FirstWrite -1}
		cnt_scatter_1 {Type I LastRead 7 FirstWrite -1}
		cnt_scatter_2 {Type I LastRead 7 FirstWrite -1}
		cnt_scatter_3 {Type I LastRead 7 FirstWrite -1}
		cnt_gather_0 {Type I LastRead 7 FirstWrite -1}
		cnt_gather_1 {Type I LastRead -1 FirstWrite -1}
		cnt_gather_2 {Type I LastRead -1 FirstWrite -1}
		cnt_gather_3 {Type I LastRead -1 FirstWrite -1}
		exist_0 {Type I LastRead 8 FirstWrite -1}
		exist_1 {Type I LastRead 8 FirstWrite -1}
		exist_2 {Type I LastRead 8 FirstWrite -1}
		exist_3 {Type I LastRead 8 FirstWrite -1}
