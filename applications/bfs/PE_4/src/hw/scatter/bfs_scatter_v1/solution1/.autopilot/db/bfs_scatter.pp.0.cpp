# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.cpp" 2
# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 1
...
# 5 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 2
...
# 6 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 2
...
# 7 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 2
...
# 8 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 2
...
# 9 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 2
...
# 10 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.h" 2
...
__attribute__((sdx_kernel("BFS_Scatter", 0))) void BFS_Scatter (
  ...
  ap_uint<64> tmp_dist[32][4096]);
}
# 2 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.cpp" 2





void WrDist (hls::stream<trans_pkt> &wr_port, const ap_uint<64> tmp_dist[32][4096], const uint8_t idx)
{
...
void feed_network(hls::stream<trans_pkt> &rd_port, hls::stream<uint32_t> &rd_req,
  ...
  ap_uint<64> tmp_dist[32][4096], hls::stream<uint32_t> &sw_data_0, hls::stream<uint32_t> &sw_data_1,
...
#pragma HLS pipeline II=1
 rd_pkt = rd_port.read();
      ...
      if (tmp_edge[0].range(31,24) == ap_uint<8>(0))
      {
        ...
        srcVal = tmp_dist[srcIdx%32][srcIdx/(32*8)];
        switch ((srcIdx/32) % 8) {
          case 0:
...
__attribute__((sdx_kernel("BFS_Scatter", 0))) void BFS_Scatter (
  ...
  volatile bool resWrite,
  ap_uint<64> tmp_dist[32][4096])
{_ssdm_SpecArrayDimSize(tmp_dist, 32);
#pragma HLS TOP name=BFS_Scatter
# 250 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_4/src/hw/scatter/bfs_scatter.cpp"
...
#pragma HLS bind_storage variable=mem_req_buff[1] type=ram_2p impl=bram
 ...
 const ap_uint<8> ZERO = 0;
  ...
  int n_vertex_iter = N_Vertex/(4*64);
  int rlt_tail_idx = N_Vertex/4 + 1;
  ...
  *launch_recv = 0;
  ...
  if (resWrite == 1)
  {
    uint16_t n_wr_iter = (N_Vertex%(4*8*2*128)==0) ? N_Vertex/(4*8*2*128) : N_Vertex/(4*8*2*128)+1;
...
#pragma HLS protocol fixed
 _ssdm_op_Wait(1);
  ...
  if (*glblIterIdx == 0)
  {
    ...
    {
      INIT_L0_1: for (uint8_t k=0; k<32; ++k) {
#pragma HLS unroll factor=32
 tmp_dist[k][i] = MASK;
    ...
    if (root % 4 == peID)
    {
      ...
      tmp_dist[rootBank][rootIdx/(32*8)] = wrVal;
    }
  }
  ...
  *launch_recv = 1;
  ...
  if (*glblIterIdx == 0) {
    *rd_baseAddr = (uint64_t)CSR_V;
    BuffOfst(rd_port, rd_req, rd_start, ofst_buff, N_Vertex/16+2);
  }
