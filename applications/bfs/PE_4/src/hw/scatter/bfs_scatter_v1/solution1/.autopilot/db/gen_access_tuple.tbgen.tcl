...
set C_modelArgList {
	{ ofst_buff int 64 regular {array 393216 { 1 1 } 1 1 }  }
	{ rlt_tail_idx int 31 regular  }
	{ batchIdx int 25 regular  }
	{ n_mem_tuples int 16 regular {pointer 1}  }
	{ mem_req_buff int 32 regular {array 2048 { 3 0 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "ofst_buff", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "rlt_tail_idx", "interface" : "wire", "bitwidth" : 31, "direction" : "READONLY"} , 
 	{ "Name" : "batchIdx", "interface" : "wire", "bitwidth" : 25, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ofst_buff_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "ofst_buff", "role": "address0" }} , 
 	...
 	{ "name": "ofst_buff_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":19, "type": "signal", "bundle":{"name": "ofst_buff", "role": "address1" }} , 
 	...
 	{ "name": "rlt_tail_idx", "direction": "in", "datatype": "sc_lv", "bitwidth":31, "type": "signal", "bundle":{"name": "rlt_tail_idx", "role": "default" }} , 
 	{ "name": "batchIdx", "direction": "in", "datatype": "sc_lv", "bitwidth":25, "type": "signal", "bundle":{"name": "batchIdx", "role": "default" }} , 
 	...
 	{ "name": "mem_req_buff_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "mem_req_buff", "role": "address1" }} , 
...
set Spec2ImplPortList { 
	ofst_buff { ap_memory {  { ofst_buff_address0 mem_address 1 19 }  { ofst_buff_ce0 mem_ce 1 1 }  { ofst_buff_q0 mem_dout 0 64 }  { ofst_buff_address1 MemPortADDR2 1 19 }  { ofst_buff_ce1 MemPortCE2 1 1 }  { ofst_buff_q1 MemPortDOUT2 0 64 } } }
	rlt_tail_idx { ap_none {  { rlt_tail_idx in_data 0 31 } } }
	batchIdx { ap_none {  { batchIdx in_data 0 25 } } }
	n_mem_tuples { ap_vld {  { n_mem_tuples out_data 1 16 }  { n_mem_tuples_ap_vld out_vld 1 1 } } }
	mem_req_buff { ap_memory {  { mem_req_buff_address1 MemPortADDR2 1 11 }  { mem_req_buff_ce1 MemPortCE2 1 1 }  { mem_req_buff_we1 MemPortWE2 1 1 }  { mem_req_buff_d1 MemPortDIN2 1 32 } } }
}
