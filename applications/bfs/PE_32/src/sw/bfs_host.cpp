...
void BuildDisCSR (void)
{
  ...
  uint tailIdx = (node_num/128+2) * 4; // 128 = 32*4
  for (k=0; k<NUM_PE; ++k)
  {
...
{
  if (argc != 6) {
    std::cout << "Usage: ./bfs <xclbin File> <n_nodes> <root> <input graph File> <kernel freq in MHz>" << endl;
    return EXIT_FAILURE;
  }
  ...
  */
  ...
  string krnl_name_full = "inst_bfs_32x1_v1:{inst_bfs_32x1_v1_1}";
  ...
  q.enqueueMigrateMemObjects({
    buffer_CSR_V[0], buffer_CSR_V[1], buffer_CSR_V[2], buffer_CSR_V[3], buffer_CSR_V[4], buffer_CSR_V[5], buffer_CSR_V[6], buffer_CSR_V[7],
    buffer_CSR_V[8], buffer_CSR_V[9], buffer_CSR_V[10], buffer_CSR_V[11], buffer_CSR_V[12], buffer_CSR_V[13], buffer_CSR_V[14], buffer_CSR_V[15],
    buffer_CSR_V[16], buffer_CSR_V[17], buffer_CSR_V[18], buffer_CSR_V[19], buffer_CSR_V[20], buffer_CSR_V[21], buffer_CSR_V[22], buffer_CSR_V[23],
    buffer_CSR_V[24], buffer_CSR_V[25], buffer_CSR_V[26], buffer_CSR_V[27], buffer_CSR_V[28], buffer_CSR_V[29], buffer_CSR_V[30], buffer_CSR_V[31],
    buffer_CSR_E[0], buffer_CSR_E[1], buffer_CSR_E[2], buffer_CSR_E[3], buffer_CSR_E[4],  buffer_CSR_E[5], buffer_CSR_E[6], buffer_CSR_E[7],
    buffer_CSR_E[8], buffer_CSR_E[9], buffer_CSR_E[10], buffer_CSR_E[11], buffer_CSR_E[12], buffer_CSR_E[13], buffer_CSR_E[14], buffer_CSR_E[15],
    buffer_CSR_E[16], buffer_CSR_E[17], buffer_CSR_E[18], buffer_CSR_E[19], buffer_CSR_E[20], buffer_CSR_E[21], buffer_CSR_E[22], buffer_CSR_E[23],
    buffer_CSR_E[24], buffer_CSR_E[25], buffer_CSR_E[26], buffer_CSR_E[27], buffer_CSR_E[28], buffer_CSR_E[29], buffer_CSR_E[30], buffer_CSR_E[31]}, 0);
  q.finish();
  ...
  q.enqueueMigrateMemObjects (
    { buffer_glbl_d[0], buffer_glbl_d[1], buffer_glbl_d[2], buffer_glbl_d[3], buffer_glbl_d[4], buffer_glbl_d[5], buffer_glbl_d[6], buffer_glbl_d[7],
      buffer_glbl_d[8], buffer_glbl_d[9], buffer_glbl_d[10], buffer_glbl_d[11], buffer_glbl_d[12], buffer_glbl_d[13], buffer_glbl_d[14], buffer_glbl_d[15],
      buffer_glbl_d[16], buffer_glbl_d[17], buffer_glbl_d[18], buffer_glbl_d[19], buffer_glbl_d[20], buffer_glbl_d[21], buffer_glbl_d[22], buffer_glbl_d[23],
      buffer_glbl_d[24], buffer_glbl_d[25], buffer_glbl_d[26], buffer_glbl_d[27], buffer_glbl_d[28], buffer_glbl_d[29], buffer_glbl_d[30], buffer_glbl_d[31]
  ...
  n_iter  = (unsigned int)w_glbl_d[0][16128].range(127,96);
  n_cycles= (unsigned int)w_glbl_d[0][16128].range(31, 0);
