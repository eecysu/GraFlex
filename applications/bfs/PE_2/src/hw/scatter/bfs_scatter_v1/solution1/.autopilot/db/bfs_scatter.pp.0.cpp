# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.cpp" 2
# 1 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 1
...
# 5 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 2
...
# 6 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 2
...
# 7 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 2
...
# 8 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 2
# 1 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_utils.h" 1
# 76 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_utils.h"
...
# 77 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/ap_utils.h" 2
# 9 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 2
...
# 73 "/opt/Xilinx/Vitis_HLS/2020.2/common/technology/autopilot/hls_stream_39.h"
namespace hls {
...
# 10 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.h" 2


typedef ap_axiu<128, 0,0,0> trans_pkt;
typedef ap_uint<33> duint33_t;


extern "C" {
__attribute__((sdx_kernel("BFS_Scatter", 0))) void BFS_Scatter (
...
# 2 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.cpp" 2





void WrDist (hls::stream<trans_pkt> &wr_port, const ap_uint<64> tmp_dist[64][4096], const uint8_t idx)
{
#pragma HLS inline off
 ...
 trans_pkt wr_pkt;
  ...
  rd_baseAddr = idx*4;
  L5: for (uint8_t i=0; i<4; ++i)
  {
#pragma HLS pipeline II=32
 L5_1: for (uint8_t j=0; j<32; ++j)
    {
...
#pragma HLS inline off
 ...
 uint16_t n_chunk = (size%16==0) ? size/16 : size/16+1;
  uint16_t n_iter = (n_chunk%16==0) ? n_chunk/16 : n_chunk/16+1;
...
void gen_access_tuple(const ap_uint<64>* ofst_buff, const uint32_t rlt_tail_idx,
                      const int batchIdx, uint16_t *n_mem_tuples, ap_uint<32>* mem_req_buff)
{
#pragma HLS inline off
#pragma HLS stable variable=n_mem_tuples
  ...
  *n_mem_tuples = 0;
  ...
  L3: for (uint8_t k=0; k<64; k++)
  {
    tmpVid = batchIdx*64 + k;
    ...
    vDegree = (nxtOfst-curOfst)*4 - padDecr;

    realDeg = (vDegree%4 == 0) ? vDegree/4 : (vDegree/4+1);
    n_full_txfr = realDeg / 16;
    n_rmdr_elem = realDeg % 16;
    ...
    L3_1: for (uint16_t j=0; j<n_full_txfr; j++)
    {
      ...
      if (n_elem_margin >= 16) {
        mem_req_buff[*n_mem_tuples] = (ap_uint<4>(16 -1), ofstAddr);
        ofstAddr += 16 *16;
      } else {
        mem_req_buff[*n_mem_tuples] = (ap_uint<4>(n_elem_margin-1), ofstAddr);
        (*n_mem_tuples)++;
        ofstAddr += n_elem_margin *16;
        mem_req_buff[*n_mem_tuples] = (ap_uint<4>(16 -n_elem_margin-1), ofstAddr);
        ofstAddr += (16 -n_elem_margin) *16;
      }
      (*n_mem_tuples)++;
    }
    next4K = (ofstAddr.range(27,12)+1) *4096;
...
void feed_network(hls::stream<trans_pkt> &rd_port, hls::stream<uint32_t> &rd_req,
  ...
  ap_uint<64> tmp_dist[64][4096], hls::stream<uint32_t> &sw_data_0, hls::stream<uint32_t> &sw_data_1,
...
#pragma HLS pipeline II=1
 rd_pkt = rd_port.read();
      ...
      {
        srcIdx = tmp_edge[0].range(23, 0);
        srcVal = tmp_dist[srcIdx%64][srcIdx/(64*8)];
        switch ((srcIdx/64) % 8) {
          case 0:
      ...
      if (invld_flag==false && srcDist != 0xff) { sw_data_0 << (srcDist, tmp_edge[0].range(23, 0)); }
...
__attribute__((sdx_kernel("BFS_Scatter", 0))) void BFS_Scatter (
  ...
  volatile bool resWrite,
  ap_uint<64> tmp_dist[64][4096])
{_ssdm_SpecArrayDimSize(tmp_dist, 64);
#pragma HLS TOP name=BFS_Scatter
# 250 "/Zodiac/GraFlex/ArtifactEvaluation/figure8/BFS_Scalability/PE_2/src/hw/scatter/bfs_scatter.cpp"
...
#pragma HLS interface ap_memory port=tmp_dist[16] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[17] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[18] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[19] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[20] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[21] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[22] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[23] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[24] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[25] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[26] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[27] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[28] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[29] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[30] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[31] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[32] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[33] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[34] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[35] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[36] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[37] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[38] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[39] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[40] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[41] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[42] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[43] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[44] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[45] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[46] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[47] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[48] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[49] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[50] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[51] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[52] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[53] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[54] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[55] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[56] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[57] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[58] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[59] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[60] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[61] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[62] storage_type=ram_1p latency=1
#pragma HLS interface ap_memory port=tmp_dist[63] storage_type=ram_1p latency=1


ap_uint<64> ofst_buff[192*4096];
#pragma HLS bind_storage variable=ofst_buff type=ram_2p impl=uram latency=1

ap_uint<32> mem_req_buff[2][4096];
...
#pragma HLS bind_storage variable=mem_req_buff[1] type=ram_2p impl=bram
 ...
 const ap_uint<8> ZERO = 0;
  ...
  int n_vertex_iter = N_Vertex/(2*64);
  int rlt_tail_idx = N_Vertex/2 + 1;
  ...
  *launch_recv = 0;
  ...
  if (resWrite == 1)
  {
    uint16_t n_wr_iter = (N_Vertex%(2*8*2*128)==0) ? N_Vertex/(2*8*2*128) : N_Vertex/(2*8*2*128)+1;
    ...
    *wr_start = 1;
    ...
    {
      WrDist(wr_port, tmp_dist, i);
    }
    *wr_start = 0;


    *wr_len = 1;
    *wr_baseAddr = (uint64_t)(glbl_d +16128*16);
    if (peID == 0) {
...
#pragma HLS protocol fixed
 _ssdm_op_Wait(1);
  ...
  if (*glblIterIdx == 0)
  {
    ...
    {
      INIT_L0_1: for (uint8_t k=0; k<64; ++k) {
#pragma HLS unroll factor=64
 tmp_dist[k][i] = MASK;
    ...
    if (root % 2 == peID)
    {
      ...
      tmp_dist[rootBank][rootIdx/(64*8)] = wrVal;
    }
  }
  ...
  *launch_recv = 1;
  ...
  if (*glblIterIdx == 0) {
    *rd_baseAddr = (uint64_t)CSR_V;
    BuffOfst(rd_port, rd_req, rd_start, ofst_buff, N_Vertex/8+2);
  }
  *rd_baseAddr = (uint64_t)CSR_E;
  ...
  L1: for (int i=0; i<n_vertex_iter+2; i++)
  {
    if (i%2 == 0) {
