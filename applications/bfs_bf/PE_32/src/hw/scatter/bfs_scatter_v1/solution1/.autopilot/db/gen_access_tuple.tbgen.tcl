...
set C_modelArgList {
	{ ofst_buff int 64 regular {array 49152 { 1 1 } 1 1 }  }
	{ rlt_tail_idx int 28 regular  }
	{ batchIdx int 22 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ofst_buff", "interface" : "memory", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "rlt_tail_idx", "interface" : "wire", "bitwidth" : 28, "direction" : "READONLY"} , 
 	{ "Name" : "batchIdx", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ ofst_buff_address0 sc_out sc_lv 16 signal 0 } 
	{ ofst_buff_ce0 sc_out sc_logic 1 signal 0 } 
	{ ofst_buff_q0 sc_in sc_lv 64 signal 0 } 
	{ ofst_buff_address1 sc_out sc_lv 16 signal 0 } 
	{ ofst_buff_ce1 sc_out sc_logic 1 signal 0 } 
	{ ofst_buff_q1 sc_in sc_lv 64 signal 0 } 
	{ rlt_tail_idx sc_in sc_lv 28 signal 1 } 
	{ batchIdx sc_in sc_lv 22 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "ofst_buff_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "ofst_buff", "role": "address0" }} , 
 	...
 	{ "name": "ofst_buff_address1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "ofst_buff", "role": "address1" }} , 
 	...
 	{ "name": "rlt_tail_idx", "direction": "in", "datatype": "sc_lv", "bitwidth":28, "type": "signal", "bundle":{"name": "rlt_tail_idx", "role": "default" }} , 
 	{ "name": "batchIdx", "direction": "in", "datatype": "sc_lv", "bitwidth":22, "type": "signal", "bundle":{"name": "batchIdx", "role": "default" }} , 
...
set Spec2ImplPortList { 
	ofst_buff { ap_memory {  { ofst_buff_address0 mem_address 1 16 }  { ofst_buff_ce0 mem_ce 1 1 }  { ofst_buff_q0 mem_dout 0 64 }  { ofst_buff_address1 MemPortADDR2 1 16 }  { ofst_buff_ce1 MemPortCE2 1 1 }  { ofst_buff_q1 MemPortDOUT2 0 64 } } }
	rlt_tail_idx { ap_none {  { rlt_tail_idx in_data 0 28 } } }
	batchIdx { ap_none {  { batchIdx in_data 0 22 } } }
