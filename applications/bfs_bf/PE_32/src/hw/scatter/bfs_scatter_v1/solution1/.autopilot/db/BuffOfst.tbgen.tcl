...
set C_modelArgList {
	...
	{ ofst_buff int 64 regular {array 49152 { 3 0 } 0 1 }  }
...
set portList { 
	...
	{ ofst_buff_address1 sc_out sc_lv 16 signal 2 } 
...
set Spec2ImplPortList { 
	...
	ofst_buff { ap_memory {  { ofst_buff_address1 MemPortADDR2 1 16 }  { ofst_buff_ce1 MemPortCE2 1 1 }  { ofst_buff_we1 MemPortWE2 1 1 }  { ofst_buff_d1 MemPortDIN2 1 64 } } }
