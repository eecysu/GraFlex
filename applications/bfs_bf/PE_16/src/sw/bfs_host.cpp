...
void BuildDisCSR (void)
{
  ...
  uint tailIdx = (node_num/64+2) * 4; // 64 = 16*4
  for (k=0; k<NUM_PE; ++k)
  {
...
int main (int argc, char *argv[])
{
  ...
  */
  ...
  string krnl_name_full = "inst_bfs_16x1_v1:{inst_bfs_16x1_v1_1}";
  ...
  q.enqueueMigrateMemObjects({
    ...
    buffer_CSR_E[8], buffer_CSR_E[9], buffer_CSR_E[10], buffer_CSR_E[11], buffer_CSR_E[12], buffer_CSR_E[13], buffer_CSR_E[14], buffer_CSR_E[15]}, 0);
  q.finish();
