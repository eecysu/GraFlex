...
module Sw4X4_FIFO36_W #(
  ...
  input  ivld_c,
  input  ivld_d,
  input  [63+EXTEND_BW:0] din_a,
  input  [63+EXTEND_BW:0] din_b,
  input  [63+EXTEND_BW:0] din_c,
  input  [63+EXTEND_BW:0] din_d,     // input data
  input  ofw_output_a,
  input  ofw_output_b,
  input  ofw_output_c,
  ...
  output reg ovld_c,
  output reg ovld_d,
  output reg [63+EXTEND_BW:0] dout_a,
  output reg [63+EXTEND_BW:0] dout_b,
  output reg [63+EXTEND_BW:0] dout_c,
  output reg [63+EXTEND_BW:0] dout_d,    // output data
  ...
  wire [63+EXTEND_BW:0] fifo_a0_din;
  wire [63+EXTEND_BW:0] fifo_a0_dout; // a0
  ...
  wire [63+EXTEND_BW:0] fifo_a1_din;
  wire [63+EXTEND_BW:0] fifo_a1_dout; // a1

  wire fifo_a2_rd_en;
  reg  fifo_a2_rd_en_1d;
  wire fifo_a2_wr_en;
  wire fifo_a2_empty;
  wire fifo_a2_prog_empty;
  wire fifo_a2_full;
  wire fifo_a2_prog_full;
  wire [63+EXTEND_BW:0] fifo_a2_din;
  wire [63+EXTEND_BW:0] fifo_a2_dout; // a2
  
  wire fifo_a3_rd_en;
  reg  fifo_a3_rd_en_1d;
  wire fifo_a3_wr_en;
  wire fifo_a3_empty;
  wire fifo_a3_prog_empty;
  wire fifo_a3_full;
  wire fifo_a3_prog_full;
  wire [63+EXTEND_BW:0] fifo_a3_din;
  wire [63+EXTEND_BW:0] fifo_a3_dout; // a3
  ...
  wire [63+EXTEND_BW:0] fifo_b0_din;
  wire [63+EXTEND_BW:0] fifo_b0_dout; // b0
  ...
  wire [63+EXTEND_BW:0] fifo_b1_din;
  wire [63+EXTEND_BW:0] fifo_b1_dout; // b1

  wire fifo_b2_rd_en;
  reg  fifo_b2_rd_en_1d;
  wire fifo_b2_wr_en;
  wire fifo_b2_empty;
  wire fifo_b2_prog_empty;
  wire fifo_b2_full;
  wire fifo_b2_prog_full;
  wire [63+EXTEND_BW:0] fifo_b2_din;
  wire [63+EXTEND_BW:0] fifo_b2_dout; // b2
  
  wire fifo_b3_rd_en;
  reg  fifo_b3_rd_en_1d;
  wire fifo_b3_wr_en;
  wire fifo_b3_empty;
  wire fifo_b3_prog_empty;
  wire fifo_b3_full;
  wire fifo_b3_prog_full;
  wire [63+EXTEND_BW:0] fifo_b3_din;
  wire [63+EXTEND_BW:0] fifo_b3_dout; // b3

  wire fifo_c0_rd_en;
  reg  fifo_c0_rd_en_1d;
  wire fifo_c0_wr_en;
  wire fifo_c0_empty;
  wire fifo_c0_prog_empty;
  wire fifo_c0_full;
  wire fifo_c0_prog_full;
  wire [63+EXTEND_BW:0] fifo_c0_din;
  wire [63+EXTEND_BW:0] fifo_c0_dout; // c0
  
  wire fifo_c1_rd_en;
  reg  fifo_c1_rd_en_1d;
  wire fifo_c1_wr_en;
  wire fifo_c1_empty;
  wire fifo_c1_prog_empty;
  wire fifo_c1_full;
  wire fifo_c1_prog_full;
  wire [63+EXTEND_BW:0] fifo_c1_din;
  wire [63+EXTEND_BW:0] fifo_c1_dout; // c1

  wire fifo_c2_rd_en;
  reg  fifo_c2_rd_en_1d;
  wire fifo_c2_wr_en;
  wire fifo_c2_empty;
  wire fifo_c2_prog_empty;
  wire fifo_c2_full;
  wire fifo_c2_prog_full;
  wire [63+EXTEND_BW:0] fifo_c2_din;
  wire [63+EXTEND_BW:0] fifo_c2_dout; // c2
  
  wire fifo_c3_rd_en;
  reg  fifo_c3_rd_en_1d;
  wire fifo_c3_wr_en;
  wire fifo_c3_empty;
  wire fifo_c3_prog_empty;
  wire fifo_c3_full;
  wire fifo_c3_prog_full;
  wire [63+EXTEND_BW:0] fifo_c3_din;
  wire [63+EXTEND_BW:0] fifo_c3_dout; // c3

  wire fifo_d0_rd_en;
  reg  fifo_d0_rd_en_1d;
  wire fifo_d0_wr_en;
  wire fifo_d0_empty;
  wire fifo_d0_prog_empty;
  wire fifo_d0_full;
  wire fifo_d0_prog_full;
  wire [63+EXTEND_BW:0] fifo_d0_din;
  wire [63+EXTEND_BW:0] fifo_d0_dout; // d0
  
  wire fifo_d1_rd_en;
  reg  fifo_d1_rd_en_1d;
  wire fifo_d1_wr_en;
  wire fifo_d1_empty;
  wire fifo_d1_prog_empty;
  wire fifo_d1_full;
  wire fifo_d1_prog_full;
  wire [63+EXTEND_BW:0] fifo_d1_din;
  wire [63+EXTEND_BW:0] fifo_d1_dout; // d1

  wire fifo_d2_rd_en;
  reg  fifo_d2_rd_en_1d;
  wire fifo_d2_wr_en;
  wire fifo_d2_empty;
  wire fifo_d2_prog_empty;
  wire fifo_d2_full;
  wire fifo_d2_prog_full;
  wire [63+EXTEND_BW:0] fifo_d2_din;
  wire [63+EXTEND_BW:0] fifo_d2_dout; // d2
  
  wire fifo_d3_rd_en;
  reg  fifo_d3_rd_en_1d;
  wire fifo_d3_wr_en;
  wire fifo_d3_empty;
  wire fifo_d3_prog_empty;
  wire fifo_d3_full;
  wire fifo_d3_prog_full;
  wire [63+EXTEND_BW:0] fifo_d3_din;
  wire [63+EXTEND_BW:0] fifo_d3_dout; // d3
  ...
  wire ovld_c_w;
  wire ovld_d_w;
  wire [63+EXTEND_BW:0] dout_a_w;
  wire [63+EXTEND_BW:0] dout_b_w;
  wire [63+EXTEND_BW:0] dout_c_w;
  wire [63+EXTEND_BW:0] dout_d_w;
  wire ofw_a_w;
  wire ofw_b_w;
  wire ofw_c_w;
  wire ofw_d_w;
  ...
  reg ovld_c_r;
  reg ovld_d_r;
  reg [63+EXTEND_BW:0] dout_a_r;
  reg [63+EXTEND_BW:0] dout_b_r;
  reg [63+EXTEND_BW:0] dout_c_r;
  reg [63+EXTEND_BW:0] dout_d_r;
  reg ofw_a_r;
  reg ofw_b_r;
  reg ofw_c_r;
  reg ofw_d_r;
