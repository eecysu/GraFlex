...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "EXTEND_BW" -parent ${Page_0}
...
proc update_PARAM_VALUE.EXTEND_BW { PARAM_VALUE.EXTEND_BW } {
	# Procedure called to update EXTEND_BW when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.EXTEND_BW { PARAM_VALUE.EXTEND_BW } {
	# Procedure called to validate EXTEND_BW
	return true
}
...
proc update_MODELPARAM_VALUE.EXTEND_BW { MODELPARAM_VALUE.EXTEND_BW PARAM_VALUE.EXTEND_BW } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.EXTEND_BW}] ${MODELPARAM_VALUE.EXTEND_BW}
}
