...
HD_PWD='/Orion/GraphHBM/UTIL_IP/Sw4X4_FIFO36_W/Sw4X4_FIFO36_W.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sw4X4_FIFO36_W.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sw4X4_FIFO36_W.tcl
