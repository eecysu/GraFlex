...
HD_PWD='/Orion/GraphHBM/UTIL_IP/IP_8URAM_2W2R_WE/8_uram_2e_wrapper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uram_2w_2r_we_x8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uram_2w_2r_we_x8.tcl
