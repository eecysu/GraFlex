...
#
# Generated by export_simulation on Fri Mar 17 12:02:04 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uram_wex8.sh' script.

./uram_wex8.sh -reset_run
...
./uram_wex8.sh -noclean_files

For more information on the script, please type './uram_wex8.sh -help'.
