...
HD_PWD='/Orion/GraphHBM/UTIL_IP/Dist1X4/Dist1X4_LUT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dist1X4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dist1X4.tcl
