...
HD_PWD='/Orion/GraphHBM/UTIL_IP/Sw2X2_FIFO18/Sw2X2_FIFO18.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sw2X2_FIFO18.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sw2X2_FIFO18.tcl
