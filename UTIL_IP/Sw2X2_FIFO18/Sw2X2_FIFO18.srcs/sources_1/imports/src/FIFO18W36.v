...
module FIFO18W36 #(
  ...
  wire [31:0] i_din, i_dout;
  
  assign dout  = i_dout[C_DATA_WIDTH-1:0];
  assign i_din = {{(32-C_DATA_WIDTH){1'b0}}, din};
   ...
   FIFO18E2_inst (
      ...
      .DOUT         ( i_dout      ), // 32-bit output: FIFO data output bus
      ...
      .DIN          ( i_din       ), // 32-bit input: FIFO data input bus
