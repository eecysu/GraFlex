...
HD_PWD='/Orion/GraphHBM/UTIL_IP/Sw4X4_FIFO18/Sw4X4_FIFO18.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sw4X4_FIFO18.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sw4X4_FIFO18.tcl
