...
#
# Generated by export_simulation on Sun May 07 10:35:07 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uramx8.sh' script.
...
./uramx8.sh -noclean_files

For more information on the script, please type './uramx8.sh -help'.
