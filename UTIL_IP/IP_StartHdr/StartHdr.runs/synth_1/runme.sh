...
HD_PWD='/home/chunyou/Xilinx/GraphHBM/UTIL_IP/IP_StartHdr/StartHdr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log StartHdr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source StartHdr.tcl
