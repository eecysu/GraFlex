...
#
# Generated by export_simulation on Mon May 08 18:54:50 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uramx4.sh' script.
...
./uramx4.sh -noclean_files

For more information on the script, please type './uramx4.sh -help'.
