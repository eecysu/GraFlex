...
#
# Generated by export_simulation on Sun May 07 10:41:42 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uramx2.sh' script.
...
./uramx2.sh -noclean_files

For more information on the script, please type './uramx2.sh -help'.
