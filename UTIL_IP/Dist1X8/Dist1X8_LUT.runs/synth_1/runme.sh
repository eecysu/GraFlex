...
HD_PWD='/Orion/GraphHBM/UTIL_IP/Dist1X8/Dist1X8_LUT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dist1X8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dist1X8.tcl
