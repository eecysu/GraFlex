...
HD_PWD='/Orion/GraphHBM/UTIL_IP/IP_URAM_2W2R_WE/uram_2w2r_we.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uram_2w_2r_we.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uram_2w_2r_we.tcl
