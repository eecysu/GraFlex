...
#
# Generated by export_simulation on Sun May 07 10:31:44 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uramx16.sh' script.

./uramx16.sh -reset_run
...
./uramx16.sh -noclean_files

For more information on the script, please type './uramx16.sh -help'.
