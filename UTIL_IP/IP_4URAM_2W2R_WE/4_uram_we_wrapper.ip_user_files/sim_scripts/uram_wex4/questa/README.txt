...
#
# Generated by export_simulation on Sun May 07 10:22:18 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uram_wex4.sh' script.

./uram_wex4.sh -reset_run
...
./uram_wex4.sh -noclean_files

For more information on the script, please type './uram_wex4.sh -help'.
