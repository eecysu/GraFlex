...
HD_PWD='/Orion/GraphHBM/UTIL_IP/UAdderCarrier/uadder_carrier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log UAdderCarrier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source UAdderCarrier.tcl
