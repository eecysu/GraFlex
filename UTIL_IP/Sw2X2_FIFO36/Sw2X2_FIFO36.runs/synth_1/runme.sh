...
HD_PWD='/home/chunyou/Xilinx/GraphHBM/UTIL_IP/Sw2X2_FIFO36/Sw2X2_FIFO36.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Sw2X2_FIFO36.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Sw2X2_FIFO36.tcl
