...
(
  ...
  input  wire [8*ADDR_WIDTH-1:0] addr0,
  input  wire [8*ADDR_WIDTH-1:0] addr1,
  input  wire [8*DATA_WIDTH-1:0] wdata0,
  input  wire [8*DATA_WIDTH-1:0] wdata1,
  output wire [8*DATA_WIDTH-1:0] rdata0,
  output wire [8*DATA_WIDTH-1:0] rdata1
);

  logic [DATA_WIDTH-1:0] rdata0_w[0:8-1];
  logic [DATA_WIDTH-1:0] rdata1_w[0:8-1];
