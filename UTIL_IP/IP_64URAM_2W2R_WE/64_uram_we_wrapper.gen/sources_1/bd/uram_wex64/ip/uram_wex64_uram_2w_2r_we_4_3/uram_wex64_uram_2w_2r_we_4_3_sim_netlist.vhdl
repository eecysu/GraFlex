...
-- Date        : Mon Sep 18 23:08:12 2023
-- Host        : noah running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /Orion/GraphHBM/UTIL_IP/IP_64URAM_2W2R_WE/64_uram_we_wrapper.gen/sources_1/bd/uram_wex64/ip/uram_wex64_uram_2w_2r_we_4_3/uram_wex64_uram_2w_2r_we_4_3_sim_netlist.vhdl
-- Design      : uram_wex64_uram_2w_2r_we_4_3
...
entity uram_wex64_uram_2w_2r_we_4_3_uram_2w_2r_we is
  port (
  ...
  attribute ORIG_REF_NAME of uram_wex64_uram_2w_2r_we_4_3_uram_2w_2r_we : entity is "uram_2w_2r_we";
end uram_wex64_uram_2w_2r_we_4_3_uram_2w_2r_we;

architecture STRUCTURE of uram_wex64_uram_2w_2r_we_4_3_uram_2w_2r_we is
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity uram_wex64_uram_2w_2r_we_4_3 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    ce0 : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of uram_wex64_uram_2w_2r_we_4_3 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of uram_wex64_uram_2w_2r_we_4_3 : entity is "uram_wex64_uram_2w_2r_we_4_3,uram_2w_2r_we,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of uram_wex64_uram_2w_2r_we_4_3 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of uram_wex64_uram_2w_2r_we_4_3 : entity is "package_project";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of uram_wex64_uram_2w_2r_we_4_3 : entity is "uram_2w_2r_we,Vivado 2020.2";
end uram_wex64_uram_2w_2r_we_4_3;

architecture STRUCTURE of uram_wex64_uram_2w_2r_we_4_3 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN uram_wex64_clk_0, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of rst_n : signal is "xilinx.com:signal:reset:1.0 rst_n RST";
  attribute X_INTERFACE_PARAMETER of rst_n : signal is "XIL_INTERFACENAME rst_n, POLARITY ACTIVE_LOW, INSERT_VIP 0";
begin
inst: entity work.uram_wex64_uram_2w_2r_we_4_3_uram_2w_2r_we
     port map (
