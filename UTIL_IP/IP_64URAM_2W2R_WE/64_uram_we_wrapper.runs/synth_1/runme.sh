...
HD_PWD='/Orion/GraphHBM/UTIL_IP/IP_64URAM_2W2R_WE/64_uram_we_wrapper.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uram_2w_2r_we_x64.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uram_2w_2r_we_x64.tcl
