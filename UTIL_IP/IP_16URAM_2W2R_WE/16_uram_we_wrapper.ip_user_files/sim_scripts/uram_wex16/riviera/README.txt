...
#
# Generated by export_simulation on Fri Mar 17 12:04:04 HKT 2023
#
################################################################################
...
'-reset_run' switch to the './uram_wex16.sh' script.

./uram_wex16.sh -reset_run
...
./uram_wex16.sh -noclean_files

For more information on the script, please type './uram_wex16.sh -help'.
