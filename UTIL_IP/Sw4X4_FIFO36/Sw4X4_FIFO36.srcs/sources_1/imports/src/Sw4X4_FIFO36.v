...
module Sw4X4_FIFO36 #(
  ...
  parameter integer FIFO_FULL_TH = 1020
) (
  input  clk,
  input  rst,
  input  ivld_a,
  ...
  output [31:0] dout_b,
  output [31:0] dout_c,
  output [31:0] dout_d,    // output data
  output ofw_input_a,
  output ofw_input_b,
  output ofw_input_c,
  output ofw_input_d       // overflow flag of input PC
);
  ...
  wire [31:0] fifo_a2_din;
  wire [31:0] fifo_a2_dout; // a2
  ...
  wire [31:0] fifo_a3_din;
  wire [31:0] fifo_a3_dout; // a3
  ...
  wire [31:0] fifo_b2_din;
  wire [31:0] fifo_b2_dout; // b2
  ...
  wire [31:0] fifo_b3_din;
  wire [31:0] fifo_b3_dout; // b3
  ...
  wire [31:0] fifo_c0_din;
  wire [31:0] fifo_c0_dout; // c0
  ...
  wire [31:0] fifo_c1_din;
  wire [31:0] fifo_c1_dout; // c1
  ...
  wire [31:0] fifo_c2_din;
  wire [31:0] fifo_c2_dout; // c2
  ...
  wire [31:0] fifo_c3_din;
  wire [31:0] fifo_c3_dout; // c3
  ...
  wire [31:0] fifo_d0_din;
  wire [31:0] fifo_d0_dout; // d0
  ...
  wire [31:0] fifo_d1_din;
  wire [31:0] fifo_d1_dout; // d1
  ...
  wire [31:0] fifo_d2_din;
  wire [31:0] fifo_d2_dout; // d2
  ...
  wire [31:0] fifo_d3_din;
  wire [31:0] fifo_d3_dout; // d3
...
assign ofw_input_a = (fifo_a0_prog_full | fifo_a1_prog_full | fifo_a2_prog_full | fifo_a3_prog_full);
assign ofw_input_b = (fifo_b0_prog_full | fifo_b1_prog_full | fifo_b2_prog_full | fifo_b3_prog_full);
assign ofw_input_c = (fifo_c0_prog_full | fifo_c1_prog_full | fifo_c2_prog_full | fifo_c3_prog_full);
assign ofw_input_d = (fifo_d0_prog_full | fifo_d1_prog_full | fifo_d2_prog_full | fifo_d3_prog_full);
...
assign ovld_a =(fifo_a0_rd_en_1d | fifo_d1_rd_en_1d | fifo_c2_rd_en_1d | fifo_b3_rd_en_1d | 
                s_input_a0 | s_input_d1 | s_input_c2 | s_input_b3) & MA_a_vld;                
assign ovld_b =(fifo_b0_rd_en_1d | fifo_a1_rd_en_1d | fifo_d2_rd_en_1d | fifo_c3_rd_en_1d | 
                s_input_b0 | s_input_a1 | s_input_d2 | s_input_c3) & MA_b_vld;                
assign ovld_c =(fifo_c0_rd_en_1d | fifo_b1_rd_en_1d | fifo_a2_rd_en_1d | fifo_d3_rd_en_1d | 
                s_input_c0 | s_input_b1 | s_input_a2 | s_input_d3) & MA_c_vld;                
assign ovld_d =(fifo_d0_rd_en_1d | fifo_c1_rd_en_1d | fifo_b2_rd_en_1d | fifo_a3_rd_en_1d | 
