...
HD_PWD='/home/chunyou/Xilinx/GraphHBM/UTIL_IP/IP_DFF_4VAR/dff_4var.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dff_4var.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dff_4var.tcl
