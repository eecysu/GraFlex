...
(
  ...
  input  wire [DATA_WIDTH-1:0]  wdata1
	...
	wire [DATA_WIDTH-1:0] i_wdata0;
	wire [DATA_WIDTH-1:0] i_wdata1;
	wire					i_we0;
	wire					i_we1;
	...
	// write logic
	assign i_we0 = we0;
	assign i_we1 = (we1 & ~mrg_wr) ? 1'b1 : 1'b0; // turn off write enable if there is conflict

	assign i_wdata0 = mrg_wr ? (wdata0 | wdata1) :
										(warn_cflt & we1_1d & we0) ? (wdata1_r | wdata0) : wdata0;
	assign i_wdata1 = (warn_cflt & we0_1d & we1) ? (wdata0_r | wdata1) : wdata1;
...
// +---------------------------------------------------------------------------------------------------------------------+
   ...
   xpm_memory_tdpram_inst (
      ...
      .clkb(1'b0),
      .dina(i_wdata0),         // WRITE_DATA_WIDTH_A-bit input: Data input for port A write operations.
      .dinb(i_wdata1),         // WRITE_DATA_WIDTH_B-bit input: Data input for port B write operations.
