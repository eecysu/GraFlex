...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter is
  ...
  signal \count_r[3]_i_5_n_0\ : STD_LOGIC;
  ...
  signal load_burst_cntr0 : STD_LOGIC;
  signal load_burst_cntr05_out : STD_LOGIC;
  signal p_4_in : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count_r[2]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \count_r[3]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \count_r[3]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of wfirst_i_1 : label is "soft_lutpair20";
begin
...
\count_r[2]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"ABABA8A8ABA8A8AB"
    )
        port map (
      I0 => Q(2),
      I1 => load_burst_cntr0,
      I2 => load_burst_cntr05_out,
...
\count_r[3]_i_1__3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EA"
    )
        port map (
      I0 => load_burst_cntr05_out,
      I1 => m_axi_WREADY,
      I2 => m_axis_tvalid,
      O => is_zero_r
    );
...
\count_r[3]_i_3__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
      I0 => start,
      I1 => is_zero_r_reg_1(1),
      I2 => is_zero_r_reg_1(0),
      I3 => is_zero_r_reg_1(2),
      I4 => is_zero_r_reg_1(3),
      O => load_burst_cntr05_out
    );
\count_r[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"80"
    )
        port map (
...
\count_r[3]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F0E1"
    )
        port map (
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0\ is
  ...
  signal \m_axi_AWLEN1__0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \count_r[2]_i_1__2\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \is_zero_r_i_3__1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \m_axi_AWLEN[0]_INST_0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \m_axi_AWLEN[1]_INST_0\ : label is "soft_lutpair15";
...
\is_zero_r_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => start,
      I2 => \^awxfer__0\,
      I3 => \is_zero_r_i_3__1_n_0\,
      I4 => \count_r_reg_n_0_[2]\,
      I5 => \count_r_reg_n_0_[3]\,
      O => \is_zero_r_i_1__0_n_0\
    );
\is_zero_r_i_3__1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\m_axi_AWLEN[3]_INST_0_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \count_r_reg[3]_0\(3),
      I2 => \count_r_reg[3]_0\(2),
      I3 => \count_r_reg[3]_0\(0),
      I4 => \count_r_reg[3]_0\(1),
      I5 => start,
      O => \m_axi_AWLEN1__0\
    );
end STRUCTURE;
...
entity \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0_0\ is
  port (
    clear : out STD_LOGIC;
    \num_transactions_reg[3]\ : out STD_LOGIC;
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0_0\ is
  ...
  signal \^num_transactions_reg[3]\ : STD_LOGIC;
  signal \p_0_in__1\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count_r[0]_i_1__3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \count_r[1]_i_1__2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \count_r[2]_i_1__3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \is_zero_r_i_2__2\ : label is "soft_lutpair17";
begin
  clear <= \^clear\;
  \num_transactions_reg[3]\ <= \^num_transactions_reg[3]\;
...
\count_r[3]_i_1__2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\is_zero_r_i_1__1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"88888888888888B8"
        ...
        port map (
      I0 => \^num_transactions_reg[3]\,
      I1 => start,
      I2 => m_axi_BVALID,
      I3 => \is_zero_r_i_2__2_n_0\,
      I4 => \count_r_reg_n_0_[2]\,
      I5 => \count_r_reg_n_0_[3]\,
      O => \is_zero_r_i_1__1_n_0\
    );
\is_zero_r_i_2__1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
      ...
      I2 => Q(1),
      I3 => Q(0),
      O => \^num_transactions_reg[3]\
    );
\is_zero_r_i_2__2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0_1\ is
  ...
  signal is_zero_r1 : STD_LOGIC;
  signal is_zero_r12_out : STD_LOGIC;
  signal \is_zero_r_i_1__2_n_0\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count_r[0]_i_1__1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \count_r[1]_i_1__3\ : label is "soft_lutpair21";
begin
...
\count_r[1]_i_1__3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"A6665999"
    )
        port map (
...
architecture STRUCTURE of \decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0_2\ is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \count_r[0]_i_1__0\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \count_r[1]_i_1__0\ : label is "soft_lutpair22";
begin
...
\count_r[3]_i_2__1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => w_transactions_to_go(0),
      I3 => w_transactions_to_go(1),
      I4 => w_transactions_to_go(3),
      I5 => w_transactions_to_go(2),
      O => p_0_in(3)
    );
\count_r_reg[0]\: unisim.vcomponents.FDRE
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_swr_engine is
  ...
  signal inst_b_transaction_cntr_n_1 : STD_LOGIC;
  signal inst_burst_cntr_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \addr[1]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \addr[2]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \addr[3]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \addr[4]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \addr[5]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \final_burst_len[1]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \final_burst_len[2]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \final_burst_len[3]_i_1\ : label is "soft_lutpair23";
  attribute AXIS_DATA_WIDTH : integer;
  ...
  attribute SOFT_HLUTNM of \num_transactions[0]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \num_transactions[2]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \num_transactions[3]_i_1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of wfirst_d1_i_1 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of wfirst_pulse_i_1 : label is "soft_lutpair24";
begin
...
inst_aw_transaction_cntr: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0\
     port map (
      ...
      is_zero_r_reg_1 => inst_b_transaction_cntr_n_1,
...
inst_b_transaction_cntr: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0_0\
     port map (
      ...
      \num_transactions_reg[3]\ => inst_b_transaction_cntr_n_1,
      req_done => req_done,
      rst_n => rst_n,
      start => start
    );
inst_burst_cntr: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter
     port map (
      E(0) => inst_burst_cntr_n_0,
      Q(3 downto 0) => final_burst_len(3 downto 0),
      SR(0) => clear,
      clk => clk,
      is_zero_r_reg_0 => inst_burst_cntr_n_2,
...
inst_w_transaction_cntr: entity work.\decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axi_counter__parameterized0_2\
     port map (
      ...
      clear => clear,
      clk => clk,
      \count_r_reg[3]_0\ => inst_w_transaction_cntr_n_0,
      start => start
    );
