...
//Date        : Sun Feb 12 12:12:55 2023
//Host        : noah running 64-bit Ubuntu 20.04.5 LTS
//Command     : generate_target cus_m_axi_s_128_ultra.bd
//Design      : cus_m_axi_s_128_ultra
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "cus_m_axi_s_128_ultra,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=cus_m_axi_s_128_ultra,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=6,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "cus_m_axi_s_128_ultra.hwdef" *) 
module cus_m_axi_s_128_ultra
   (clk,
    m_axi_araddr,
    m_axi_arburst,
    m_axi_arcache,
    ...
    wr_len,
    wr_start);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF s_axis_wr:m_axis_rd, ASSOCIATED_RESET rst_n, CLK_DOMAIN cus_m_axi_s_128_ultra_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  output m_axi_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rd, CLK_DOMAIN cus_m_axi_s_128_ultra_clk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [127:0]m_axis_rd_tdata;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_wr TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_wr, CLK_DOMAIN cus_m_axi_s_128_ultra_clk_0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [127:0]s_axis_wr_tdata;
  ...
  wire [127:0]mread_master_ultra_0_m_axis_TDATA;
  wire [15:0]mread_master_ultra_0_m_axis_TKEEP;
  wire mread_master_ultra_0_m_axis_TLAST;
  wire mread_master_ultra_0_m_axis_TREADY;
  wire [15:0]mread_master_ultra_0_m_axis_TSTRB;
  ...
  assign m_axis_rd_tdata[127:0] = mread_master_ultra_0_m_axis_TDATA;
  assign m_axis_rd_tkeep[15:0] = mread_master_ultra_0_m_axis_TKEEP;
  assign m_axis_rd_tlast = mread_master_ultra_0_m_axis_TLAST;
  assign m_axis_rd_tstrb[15:0] = mread_master_ultra_0_m_axis_TSTRB;
  ...
  cus_m_axi_s_128_ultra_mread_master_ultra_0_0 mread_master_ultra_0
       (.baseAddr(rd_2d_d),
        .clk(clk_0_1),
        ...
        .rst_n(rst_n_0_1));
  cus_m_axi_s_128_ultra_dff_2d_0_0 rd_2d
       (.clk(clk_0_1),
        .d(rd_2d_d),
        .q(rd_baseAddr_1));
  cus_m_axi_s_128_ultra_step_to_pulse_0_0 step_to_pulse_0
       (.clk(clk_0_1),
        .pul_out(step_to_pulse_0_pul_out),
        .step_in(rd_start_1));
  cus_m_axi_s_128_ultra_step_to_pulse_0_1 step_to_pulse_1
       (.clk(clk_0_1),
        .pul_out(step_to_pulse_1_pul_out),
        .step_in(wr_start_1));
  cus_m_axi_s_128_ultra_swr_engine_0_0 swr_engine_0
       (.baseAddr(wr_2d_d),
        .clk(clk_0_1),
  ...
  cus_m_axi_s_128_ultra_dff_2d_0_1 wr_2d
       (.clk(clk_0_1),
        .d(wr_2d_d),
        .q(wr_baseAddr_1));
endmodule
