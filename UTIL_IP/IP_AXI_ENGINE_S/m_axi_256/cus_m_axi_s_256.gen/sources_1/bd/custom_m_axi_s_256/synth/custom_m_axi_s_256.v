...
//Date        : Fri Jan  6 21:55:42 2023
//Host        : noah running 64-bit Ubuntu 20.04.5 LTS
//Command     : generate_target custom_m_axi_s_256.bd
//Design      : custom_m_axi_s_256
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "custom_m_axi_s_256,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=custom_m_axi_s_256,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=4,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "custom_m_axi_s_256.hwdef" *) 
module custom_m_axi_s_256
   (clk,
    m_axi_araddr,
    m_axi_arburst,
    m_axi_arcache,
    ...
    wr_len,
    wr_start);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF s_axis_wr:m_axis_rd, CLK_DOMAIN custom_m_axi_s_256_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  output m_axi_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rd, CLK_DOMAIN custom_m_axi_s_256_clk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 32, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [255:0]m_axis_rd_tdata;
  ...
  wire [255:0]mread_master_0_m_axis_TDATA;
  wire [31:0]mread_master_0_m_axis_TKEEP;
  wire mread_master_0_m_axis_TLAST;
  wire mread_master_0_m_axis_TREADY;
  wire [31:0]mread_master_0_m_axis_TSTRB;
  ...
  assign m_axis_rd_tdata[255:0] = mread_master_0_m_axis_TDATA;
  assign m_axis_rd_tkeep[31:0] = mread_master_0_m_axis_TKEEP;
  assign m_axis_rd_tlast = mread_master_0_m_axis_TLAST;
  assign m_axis_rd_tstrb[31:0] = mread_master_0_m_axis_TSTRB;
  ...
  custom_m_axi_s_256_mread_master_0_0 mread_master_0
       (.baseAddr(baseAddr_0_1),
        ...
        .rst_n(rst_n_0_1));
  custom_m_axi_s_256_step_to_pulse_0_0 step_to_pulse_0
       (.clk(clk_0_1),
        .pul_out(step_to_pulse_0_pul_out),
        .step_in(step_in_0_1));
  custom_m_axi_s_256_step_to_pulse_0_1 step_to_pulse_1
       (.clk(clk_0_1),
        .pul_out(step_to_pulse_1_pul_out),
        .step_in(step_in_0_2));
  custom_m_axi_s_256_swr_engine_0_0 swr_engine_0
