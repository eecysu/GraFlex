...
HD_PWD='/Orion/GraphHBM/UTIL_IP/IP_AXI_ENGINE_S/m_axi_256/cus_m_axi_s_256.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cus_m_axi_s_256.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cus_m_axi_s_256.tcl
