...
//Date        : Fri Jan  6 21:58:58 2023
//Host        : noah running 64-bit Ubuntu 20.04.5 LTS
//Command     : generate_target cus_m_axi_s_256_ultra_wrapper.bd
//Design      : cus_m_axi_s_256_ultra_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module cus_m_axi_s_256_uram
   (clk,
    m_axi_araddr,
    m_axi_arburst,
    m_axi_arcache,
  ...
  output m_axi_wvalid;
  output [255:0]m_axis_rd_tdata;
  output [31:0]m_axis_rd_tkeep;
  output m_axis_rd_tlast;
  input m_axis_rd_tready;
  output [31:0]m_axis_rd_tstrb;
  ...
  wire m_axi_wvalid;
  wire [255:0]m_axis_rd_tdata;
  wire [31:0]m_axis_rd_tkeep;
  wire m_axis_rd_tlast;
  wire m_axis_rd_tready;
  wire [31:0]m_axis_rd_tstrb;
  ...
  cus_m_axi_s_256_ultra cus_m_axi_s_256_ultra_i
       (.clk(clk),
