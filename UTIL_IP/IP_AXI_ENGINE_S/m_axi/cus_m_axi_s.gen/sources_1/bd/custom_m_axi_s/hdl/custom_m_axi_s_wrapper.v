...
//Command     : generate_target custom_m_axi_s_wrapper.bd
//Design      : custom_m_axi_s_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module cus_m_axi_s_64
   (clk,
    m_axi_araddr,
    m_axi_arburst,
    m_axi_arcache,
  ...
  output m_axi_wvalid;
  output [63:0]m_axis_rd_tdata;
  output [7:0]m_axis_rd_tkeep;
  output m_axis_rd_tlast;
  input m_axis_rd_tready;
  output [7:0]m_axis_rd_tstrb;
  ...
  wire m_axi_wvalid;
  wire [63:0]m_axis_rd_tdata;
  wire [7:0]m_axis_rd_tkeep;
  wire m_axis_rd_tlast;
  wire m_axis_rd_tready;
  wire [7:0]m_axis_rd_tstrb;
  ...
  custom_m_axi_s custom_m_axi_s_i
       (.clk(clk),
