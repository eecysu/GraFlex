...
module custom_m_axi_s
   (clk,
    ...
    wr_len,
    wr_start);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF m_axis_rd:s_axis_wr, CLK_DOMAIN custom_m_axi_s_clk_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  output m_axi_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rd, CLK_DOMAIN custom_m_axi_s_clk_0, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [63:0]m_axis_rd_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TKEEP" *) output [7:0]m_axis_rd_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TSTRB" *) output [7:0]m_axis_rd_tstrb;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_wr " *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_wr, CLK_DOMAIN custom_m_axi_s_clk_0, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 8, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [63:0]s_axis_wr_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_wr " *) output s_axis_wr_tready;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_wr " *) input s_axis_wr_tvalid;
  ...
  wire [63:0]mread_master_0_m_axis_TDATA;
  wire [7:0]mread_master_0_m_axis_TKEEP;
  wire mread_master_0_m_axis_TLAST;
  wire mread_master_0_m_axis_TREADY;
  wire [7:0]mread_master_0_m_axis_TSTRB;
  ...
  wire [63:0]swr_engine_0_m_axi_WDATA;
  ...
  assign m_axi_rdata_1 = m_axi_rdata[63:0];
  ...
  assign m_axi_wdata[63:0] = swr_engine_0_m_axi_WDATA;
  ...
  assign m_axis_rd_tdata[63:0] = mread_master_0_m_axis_TDATA;
  assign m_axis_rd_tkeep[7:0] = mread_master_0_m_axis_TKEEP;
  assign m_axis_rd_tlast = mread_master_0_m_axis_TLAST;
  assign m_axis_rd_tstrb[7:0] = mread_master_0_m_axis_TSTRB;
  ...
  assign s_axis_0_1_TDATA = s_axis_wr_tdata[63:0];
  ...
  custom_m_axi_s_mread_master_0_3 mread_master_0
  ...
  custom_m_axi_s_step_to_pulse_0_1 step_to_pulse_1
       (.clk(clk_0_1),
        ...
        .step_in(step_in_0_2));
  custom_m_axi_s_swr_engine_0_3 swr_engine_0
