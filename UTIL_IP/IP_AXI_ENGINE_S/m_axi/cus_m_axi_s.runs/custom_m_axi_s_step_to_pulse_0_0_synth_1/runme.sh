...
HD_PWD='/home/chunyou/Xilinx/GraphHBM/UTIL_IP/IP_AXI_ENGINE_S/m_axi/cus_m_axi_s.runs/custom_m_axi_s_step_to_pulse_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log custom_m_axi_s_step_to_pulse_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source custom_m_axi_s_step_to_pulse_0_0.tcl
