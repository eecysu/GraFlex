...
HD_PWD='/Orion/GraphHBM/UTIL_IP/IP_AXI_ENGINE_S/m_axi_rd/axi_mrd_s.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mread_master.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mread_master.tcl
