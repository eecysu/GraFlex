...
HD_PWD='/Orion/GraphHBM/UTIL_IP/IP_AXI_ENGINE_S/m_axi_wr/axi_swr_s.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log swr_engine.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source swr_engine.tcl
