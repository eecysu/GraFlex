...
################################################################
# This is a generated script based on design: custom_m_axi_128
#
...
# source custom_m_axi_128_script.tcl
...
set design_name custom_m_axi_128
...
proc create_root_design { parentCell } {
  ...
  set m_axi_rdata [ create_bd_port -dir I -from 127 -to 0 m_axi_rdata ]
  ...
  set m_axi_wdata [ create_bd_port -dir O -from 127 -to 0 m_axi_wdata ]
  set m_axi_wlast [ create_bd_port -dir O m_axi_wlast ]
  set m_axi_wready [ create_bd_port -dir I m_axi_wready ]
  set m_axi_wstrb [ create_bd_port -dir O -from 15 -to 0 m_axi_wstrb ]
  ...
  connect_bd_intf_net -intf_net mread_master_0_m_axis [get_bd_intf_ports m_axis_rd] [get_bd_intf_pins mread_master_0/m_axis]
  ...
  connect_bd_net -net m_axi_ARREADY_0_1 [get_bd_ports m_axi_arready] [get_bd_pins mread_master_0/m_axi_ARREADY]
  ...
  connect_bd_net -net m_axi_RDATA_0_1 [get_bd_ports m_axi_rdata] [get_bd_pins mread_master_0/m_axi_RDATA]
  connect_bd_net -net m_axi_RID_0_1 [get_bd_ports m_axi_rid] [get_bd_pins mread_master_0/m_axi_RID]
  connect_bd_net -net m_axi_RLAST_0_1 [get_bd_ports m_axi_rlast] [get_bd_pins mread_master_0/m_axi_RLAST]
  connect_bd_net -net m_axi_RRESP_0_1 [get_bd_ports m_axi_rresp] [get_bd_pins mread_master_0/m_axi_RRESP]
  connect_bd_net -net m_axi_RVALID_0_1 [get_bd_ports m_axi_rvalid] [get_bd_pins mread_master_0/m_axi_RVALID]
  connect_bd_net -net m_axi_wready [get_bd_ports m_axi_wready] [get_bd_pins swr_engine_0/m_axi_WREADY]
  ...
  connect_bd_net -net rd_start_1 [get_bd_ports rd_start] [get_bd_pins step_to_pulse_0/step_in]
  connect_bd_net -net rst_n_0_1 [get_bd_ports rst_n] [get_bd_pins mread_master_0/rst_n] [get_bd_pins swr_engine_0/rst_n]
  ...
  connect_bd_net -net swr_engine_0_ctrl_done [get_bd_ports wr_done] [get_bd_pins swr_engine_0/ctrl_done]
  ...
  connect_bd_net -net wr_len_1 [get_bd_ports wr_len] [get_bd_pins swr_engine_0/req_len]
  connect_bd_net -net wr_start_1 [get_bd_ports wr_start] [get_bd_pins step_to_pulse_1/step_in]
