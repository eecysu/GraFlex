...
w_running_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F7A0"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_swr_engine is
  ...
  signal w_running_1d : STD_LOGIC;
  signal w_running_2d : STD_LOGIC;
...
w_running_1d_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
w_running_2d_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
