...
//Date        : Fri Jan  6 21:45:35 2023
//Host        : noah running 64-bit Ubuntu 20.04.5 LTS
//Command     : generate_target custom_m_axi_128.bd
//Design      : custom_m_axi_128
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "custom_m_axi_128,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=custom_m_axi_128,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=4,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "custom_m_axi_128.hwdef" *) 
module custom_m_axi_128
   (clk,
    m_axi_araddr,
    m_axi_arburst,
    m_axi_arcache,
    ...
    wr_len,
    wr_start);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF m_axis_rd:s_axis_wr, CLK_DOMAIN custom_m_axi_128_clk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.000" *) input clk;
  ...
  output m_axi_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME m_axis_rd, CLK_DOMAIN custom_m_axi_128_clk, FREQ_HZ 100000000, HAS_TKEEP 1, HAS_TLAST 1, HAS_TREADY 1, HAS_TSTRB 1, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) output [127:0]m_axis_rd_tdata;
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TKEEP" *) output [15:0]m_axis_rd_tkeep;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 m_axis_rd TSTRB" *) output [15:0]m_axis_rd_tstrb;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 s_axis_wr TDATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME s_axis_wr, CLK_DOMAIN custom_m_axi_128_clk, FREQ_HZ 100000000, HAS_TKEEP 0, HAS_TLAST 0, HAS_TREADY 1, HAS_TSTRB 0, INSERT_VIP 0, LAYERED_METADATA undef, PHASE 0.000, TDATA_NUM_BYTES 16, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0" *) input [127:0]s_axis_wr_tdata;
  ...
  wire [127:0]mread_master_0_m_axis_TDATA;
  wire [15:0]mread_master_0_m_axis_TKEEP;
  wire mread_master_0_m_axis_TLAST;
  wire mread_master_0_m_axis_TREADY;
  wire [15:0]mread_master_0_m_axis_TSTRB;
  wire mread_master_0_m_axis_TVALID;
  ...
  wire [127:0]swr_engine_0_m_axi_WDATA;
  wire swr_engine_0_m_axi_WLAST;
  wire [15:0]swr_engine_0_m_axi_WSTRB;
  wire swr_engine_0_m_axi_WVALID;

  assign baseAddr_0_1 = rd_baseAddr[63:0];
  assign baseAddr_0_2 = wr_baseAddr[63:0];
  assign clk_0_1 = clk;
  assign m_axi_ARREADY_0_1 = m_axi_arready;
  assign m_axi_AWREADY_0_1 = m_axi_awready;
  assign m_axi_BVALID_0_1 = m_axi_bvalid;
  assign m_axi_RDATA_0_1 = m_axi_rdata[127:0];
  ...
  assign m_axi_wdata[127:0] = swr_engine_0_m_axi_WDATA;
  assign m_axi_wlast = swr_engine_0_m_axi_WLAST;
  assign m_axi_wstrb[15:0] = swr_engine_0_m_axi_WSTRB;
  assign m_axi_wvalid = swr_engine_0_m_axi_WVALID;
  assign m_axis_rd_tdata[127:0] = mread_master_0_m_axis_TDATA;
  assign m_axis_rd_tkeep[15:0] = mread_master_0_m_axis_TKEEP;
  assign m_axis_rd_tlast = mread_master_0_m_axis_TLAST;
  assign m_axis_rd_tstrb[15:0] = mread_master_0_m_axis_TSTRB;
  assign m_axis_rd_tvalid = mread_master_0_m_axis_TVALID;
  assign mread_master_0_m_axis_TREADY = m_axis_rd_tready;
  ...
  assign s_axis_0_1_TDATA = s_axis_wr_tdata[127:0];
  ...
  assign wr_done = swr_engine_0_ctrl_done;
  custom_m_axi_128_mread_master_0_0 mread_master_0
       (.baseAddr(baseAddr_0_1),
        ...
        .m_axis_tdata(mread_master_0_m_axis_TDATA),
        .m_axis_tkeep(mread_master_0_m_axis_TKEEP),
        .m_axis_tlast(mread_master_0_m_axis_TLAST),
        .m_axis_tready(mread_master_0_m_axis_TREADY),
        .m_axis_tstrb(mread_master_0_m_axis_TSTRB),
        .m_axis_tvalid(mread_master_0_m_axis_TVALID),
        .req_din(req_din_0_1),
        ...
        .rst_n(rst_n_0_1));
  custom_m_axi_128_step_to_pulse_0_0 step_to_pulse_0
       (.clk(clk_0_1),
        .pul_out(step_to_pulse_0_pul_out),
        .step_in(step_in_0_1));
  custom_m_axi_128_step_to_pulse_0_1 step_to_pulse_1
       (.clk(clk_0_1),
        .pul_out(step_to_pulse_1_pul_out),
        .step_in(step_in_0_2));
  custom_m_axi_128_swr_engine_0_0 swr_engine_0
       (.baseAddr(baseAddr_0_2),
        .clk(clk_0_1),
        .ctrl_done(swr_engine_0_ctrl_done),
